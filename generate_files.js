...
const basePath = 'c:\\\\Users\\\\wgoss\\\\.gemini\\\\antigravity-ide\\\\scratch\\\\labvirtualw\\\\LABVIRTUALW-main';

const espectro = `<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
fs.writeFileSync(path.join(basePath, 'fisica9_espectro_auditivo.html'), espectro, 'utf8');
fs.writeFileSync(path.join(basePath, 'fisica9_intensidad_sonido.html'), intensidad, 'utf8');
fs.writeFileSync(path.join(basePath, 'fisica9_intensidad_sonido_practica.html'), practica, 'utf8');
fs.writeFileSync(path.join(basePath, 'fisica9_acustica_evaluacion.html'), evaluacion, 'utf8');

console.log('Archivos HTML creados exitosamente');
